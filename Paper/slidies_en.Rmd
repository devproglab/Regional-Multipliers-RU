...
\begin{tikzpicture}[%
    ...
    \node[blocksmalltext, align = center, below = 0.5 cm of tradeflows] (external) {Weakly exogenous};
...
```
`r figNote('scenario 1 assumes an increase in government spending in 10 regions with the highest per capita GRP (Tyumen, Sakhalin, Magadan, Murmansk, Arkhangelsk regions, Moscow, St. Petersburg, the Sakha Republic, Kamchatka Krai, the Komi Republic), scenario 2 - in 10 regions with the lowest per capita GRP (the Republics of Ingushetia, Chechnya, Kabardino-Balkaria, Tyva, Karachay-Cherkessia, Dagestan, North Ossetia, Adygea, Buryatia, Ivanovo region). The estimates are obtained on the basis of the GVAR model on the 2009-2024 sample using a recursive identification scheme. When calculating the Gini coefficient, the regions are weighted by population. The bold line indicates the value of the Gini coefficient in 2022 (0.315)')`